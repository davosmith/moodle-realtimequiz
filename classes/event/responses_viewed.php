...
/**
 * The mod_realtimequiz responses viewed event.
 *
...
/**
 * The mod_realtimequiz responses viewed event class.
 *
...
class responses_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventresponsesviewed', 'mod_realtimequiz');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'realtimequiz', 'responses', 'responses.php?id=' . $this->contextinstanceid,
