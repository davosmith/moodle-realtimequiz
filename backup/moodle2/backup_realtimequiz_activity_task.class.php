...
class backup_realtimequiz_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the realtimequiz.xml file
     */
    protected function define_my_steps() {
        $this->add_step(new backup_realtimequiz_activity_structure_step('realtimequiz structure', 'realtimequiz.xml'));
    }
    ...
    static public function encode_content_links($content) {
        ...
        // Link to the list of realtimequizs
